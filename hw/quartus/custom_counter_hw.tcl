...
add_fileset_file Custom_Counter.vhd VHDL PATH ../hdl/Custom_Counter.vhd TOP_LEVEL_FILE
...
add_interface_port avalon_slave_1 Address2 address Input 3
add_interface_port avalon_slave_1 ChipSelect2 chipselect Input 1
add_interface_port avalon_slave_1 Read2 read Input 1
add_interface_port avalon_slave_1 ReadData2 readdata Output 32
add_interface_port avalon_slave_1 Write2 write Input 1
add_interface_port avalon_slave_1 WriteData2 writedata Input 32
