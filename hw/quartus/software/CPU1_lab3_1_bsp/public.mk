...
# CPU Name 
# setting CPU_NAME is CPU_1_0_nios2_gen2_0
CPU_NAME = CPU_1_0_nios2_gen2_0
...
# Design Name 
# setting SOPC_NAME is main_system
SOPC_NAME := main_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x14000018
SOPC_SYSID_FLAG += --sidp=0x14000018
ELF_PATCH_FLAG  += --sidp 0x14000018

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1589108720
SOPC_SYSID_FLAG += --timestamp=1589108720
ELF_PATCH_FLAG  += --timestamp 1589108720
...
# setting hal.stderr is CPU_1_0_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev CPU_1_0_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is CPU_1_0_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev CPU_1_0_jtag_uart_0
...
# setting hal.stdout is CPU_1_0_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev CPU_1_0_jtag_uart_0
