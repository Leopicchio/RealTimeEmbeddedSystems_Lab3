...
# Memory: CPU_0_0_onchip_memory2_0
MEM_0 := main_system_CPU_0_0_onchip_memory2_0
$(MEM_0)_NAME := CPU_0_0_onchip_memory2_0
...
$(MEM_0)_START := 0x20010000
$(MEM_0)_END := 0x2001ffff
$(MEM_0)_SPAN := 0x00010000
$(MEM_0)_HIERARCHICAL_PATH := CPU_0_0.onchip_memory2_0
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: CPU_0_0_onchip_memory2_0
CPU_0_0_onchip_memory2_0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
